...
public class shopping2 extends SQLiteOpenHelper {
    private  static String databasename="shop1";

    SQLiteDatabase admin;
    public shopping2(Context context){
    ...
    boolean loginuser(String mail,String pw){
    ...
    public  boolean addproduct(String name , String des , String color , byte[] image , String price, String cat)
    {
        ContentValues row=new ContentValues();
        row.put("name",name);
        row.put("des",des);
  ...
  /*  public Cursor getproductt()
    ...
    */
    ...
    public Cursor searchbycat(String cat)
    {
        admin= getReadableDatabase();
        String [] arg={cat};
